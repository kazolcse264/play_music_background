                              ...
                              children: [
                                ...
                                Expanded(
                                  child:  SizedBox(
                                    ...
                                    height: 50,
                                    child: Marquee(
                                      text: playingSong?['title'] ?? 'No Title',
                                      style: Theme.of(context).textTheme.titleLarge!.copyWith(
                                        color: Provider.of<ThemeProvider>(context).isDarkMode
                                            ? Colors.white
                                            : Colors.black,
                                ...
                                PlayButton(id: playingSong?['id'] ?? 'No id found'),
                              ],
                            ),
                          ),
                        ),
                        AudioProgressBar(id: playingSong?['id'] ?? 'No id found',updateCurrentPlaybackPosition: updateCurrentPlaybackPosition,),
                      ],
                    ),
                  ),
...
class AudioProgressBar extends StatelessWidget {
  ...
  const AudioProgressBar({Key? key,required this.id, required this.updateCurrentPlaybackPosition}) : super(key: key);
...
class PlayButton extends StatelessWidget {
  ...
  const PlayButton({Key? key,required this.id,}) : super(key: key);
      ...
      builder: (_, value, __) {
        switch (value) {
          ...
          case ButtonState.paused:
            return IconButton(
              icon:  Icon(Icons.play_arrow, color: Provider.of<ThemeProvider>(context).isDarkMode
                  ? Colors.white
                  : Colors.black,),
              iconSize: 32.0,
              onPressed:  () {
          ...
          case ButtonState.playing:
            return IconButton(
              icon:  Icon(Icons.pause, color: Provider.of<ThemeProvider>(context).isDarkMode
                  ? Colors.white
                  : Colors.black,),
              iconSize: 32.0,
              onPressed: () {
  ...
  void resumePlayback(AudioHandler audioHandler, String id,MusicProvider musicProvider) {
    final currentPosition = musicProvider.getPosition(id);
